...
public class PersonalCenterVo {
	...
	public PersonalCenterVo(Long id, Date beginTime, Date endTime, GameVo game, double longitude, double latitude,
			boolean locked, int money, String name, String place, int joinMember, int joinWomanMember,
			int joinManMember, List<UserVo> joinMembers, int manCount, int womanCount, int memberCount) {
		super();
		this.id = id;
		this.beginTime = beginTime;
		this.endTime = endTime;
